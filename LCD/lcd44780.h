...
#define LCD_BACKLIGHT_PORT 	D
#define LCD_BACKLIGHT_PIN	2
//------------------------------------------------  koniec ustawieÒ sprzÍtowych ---------------

#define LCD_BACKLIGHT_INIT 	DDR( LCD_BACKLIGHT_PORT )  |= ( 1<<PIN(LCD_BACKLIGHT_PIN) )
#define LCD_BACKLIGHT_ON	PORT( LCD_BACKLIGHT_PORT ) |= ( 1<<PIN(LCD_BACKLIGHT_PIN) )
#define LCD_BACKLIGHT_OFF	PORT( LCD_BACKLIGHT_PORT ) &= ~( 1<<PIN(LCD_BACKLIGHT_PIN) )
#define LCD_BACKLIGHT_TOG	PORT( LCD_BACKLIGHT_PORT ) ^= ( 1<<PIN(LCD_BACKLIGHT_PIN) )
//----------------------------------------------------------------------------------------
//****************************************************************************************
//*																						 *
